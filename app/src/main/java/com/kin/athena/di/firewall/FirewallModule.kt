...
object FirewallModule {
  @Provides
  @Singleton
  fun provideFirewallState(): FirewallStateManager = FirewallStateManager()
  ...
  fun provideShizukuService(
    ...
    ShizukuConnectionService().apply {
      this.applicationUseCases = applicationUseCases
      this.preferencesUseCases = preferencesUseCases
  ...
  fun provideFirewallManager(
    ...
    val firewallManager =
      FirewallManager(firewallStateManager, context, rootService, vpnService, shizukuService)
