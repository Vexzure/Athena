...
@MapKey annotation class WorkerKey(
...
abstract class WorkerModule {
  ...
  abstract fun bindRuleDatabaseUpdateWorker(factory: RuleDatabaseUpdateWorkerFactory): RuleDatabaseUpdateWorkerFactory
}
