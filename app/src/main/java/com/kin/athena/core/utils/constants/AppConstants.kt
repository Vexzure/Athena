...
object AppConstants {
  ...
  object DnsBlockLists {
    ...
    object Legacy {
      const val MALWARE_PROTECTION =
        "https://raw.githubusercontent.com/DandelionSprout/adfilt/master/" +
          "Alternate%20versions%20Anti-Malware%20List/AntiMalwareHosts.txt"
      ...
      const val GAMBLING_PROTECTION =
        "https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/gambling-only/hosts"
      const val ADULT_PROTECTION =
        "https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/porn-only/hosts"
      const val SOCIAL_PROTECTION =
        "https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/social-only/hosts"
    }

    val MALWARE_PROTECTION =
      listOf(
        // DandelionSprout: solid anti-malware coverage
        "https://raw.githubusercontent.com/DandelionSprout/adfilt/master/" +
          "Alternate%20versions%20Anti-Malware%20List/AntiMalwareHosts.txt",
      )
    val AD_PROTECTION = listOf("https://small.oisd.nl")
    val ADS_EXTREME = listOf("https://blokada.org/mirror/v5/goodbyeads/standard/hosts.txt")
    val PRIVACY_PROTECTION =
      listOf(
        "https://hostfiles.frogeye.fr/firstparty-trackers-hosts.txt",
        "https://raw.githubusercontent.com/Perflyst/PiHoleBlocklist/master/android-tracking.txt",
      )
    val GAMBLING_PROTECTION =
      listOf(
        "https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/gambling-only/hosts",
      )
    val ADULT_PROTECTION =
      listOf("https://raw.githubusercontent.com/blocklistproject/Lists/master/porn.txt")
    val SOCIAL_PROTECTION =
      listOf(
        "https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/social-only/hosts",
      )
  }
