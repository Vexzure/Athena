...
class ApplicationRepositoryImpl
  ...
  constructor(
    ...
    override suspend fun getAllApplications(): List<Application> = provider.applicationDao().getAllApplications()
    ...
    override suspend fun getFilteredApplicationsCount(
      ...
      provider
        .applicationDao()
        .getFilteredApplicationsCount(showSystemPackages, showOfflinePackages, searchQuery)

    override suspend fun updatePinnedStatus(
      packageId: String,
      isPinned: Boolean,
    ) {
