...
class ConnectionStateManager
  ...
  constructor(
    ...
    private var currentConnectionType: NetworkManager.ConnectionType =
      networkManager.getCurrentConnectionType()

    fun getCurrentConnectionType(): NetworkManager.ConnectionType = currentConnectionType

    fun updateConnectionType(connectionType: NetworkManager.ConnectionType) {
      currentConnectionType = connectionType
      try {
        val clearSessionsServiceIntent =
          Intent(context, VpnConnectionServer::class.java).apply {
