...
object NetworkConstants {
  ...
  val DNS_SERVERS: List<DnsServer> =
    listOf(
  ...
  val DNS_SERVERS_LEGACY: List<Pair<String, Pair<String, String>>> =
    DNS_SERVERS.map { Pair(it.name, Pair(it.ipv4Primary, it.ipv4Secondary)) }
