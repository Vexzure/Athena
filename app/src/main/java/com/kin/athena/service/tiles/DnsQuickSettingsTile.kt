...
/**
 * Quick Settings tile for toggling DNS blocking functionality Allows users to quickly
 * enable/disable DNS blocking from the notification shade while keeping the VPN service running
 */
@AndroidEntryPoint
