...
class VpnConnectionClient : VpnService() {
  ...
  @Inject
  lateinit var applicationUseCases: com.kin.athena.domain.usecase.application.ApplicationUseCases
        ...
        applicationUseCases.getApplications
          ...
          .fold(
            ifSuccess = { apps: List<com.kin.athena.domain.model.Application> ->
              apps
                .filter { app: com.kin.athena.domain.model.Application -> app.bypassVpn }
  ...
  private fun createServiceIntent(
    fd: Int,
    action: String,
  ) = Intent(this, VpnConnectionServer::class.java).apply {
    this.action = action
