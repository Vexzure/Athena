...
object VpnManager {
  ...
  fun permissionChecker(context: Context): Boolean = VpnService.prepare(context) == null

  private fun startVpnService(context: Context) {
    val vpnServiceIntent =
      Intent(context, VpnConnectionClient::class.java).apply {
