...
/**
 * Data class representing the current network statistics state for the logging screen. Contains
 * counts of allowed, blocked, and total network requests along with firewall status.
 */
