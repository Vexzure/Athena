...
class GetFilteredApplications
  ...
  constructor(
    ...
    suspend fun execute(
      ...
      try {
        val applications =
          applicationRepository.getFilteredApplications(
            showSystemPackages,
            showOfflinePackages,
            searchQuery,
            limit,
        ...
        val totalCount =
          applicationRepository.getFilteredApplicationsCount(
            showSystemPackages,
            showOfflinePackages,
            searchQuery,
          )
        ...
        com.kin.athena.core.logging.Logger.info(
          "GetFilteredApplications: offset=$offset, limit=$limit, got ${applications.size} " +
            "apps, totalCount=$totalCount, hasMore=$hasMore",
        )
