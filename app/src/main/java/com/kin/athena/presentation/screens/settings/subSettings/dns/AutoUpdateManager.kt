...
object AutoUpdateManager {
  ...
  fun scheduleAutoUpdateWorker(
    ...
    val autoUpdateRequest =
      PeriodicWorkRequestBuilder<RuleDatabaseUpdateWorker>(intervalMinutes, TimeUnit.MINUTES)
        .addTag("auto_update_blocklists")
        .setInputData(Data.Builder().putBoolean("auto_update", true).build())
        .build()
