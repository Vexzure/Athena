...
val settingScreens =
  ...
  >(
    SettingRoutes.Settings.route to
      { settingsViewModel, navController, homeViewModel ->
        SettingsScreen(navController, settingsViewModel)
      },
    SettingRoutes.Colors.route to
      { settingsViewModel, navController, homeViewModel ->
        ColorsScreen(navController, settingsViewModel, homeViewModel)
      },
    SettingRoutes.Behavior.route to
      { settingsViewModel, navController, homeViewModel ->
        BehaviorScreen(navController, settingsViewModel)
      },
    SettingRoutes.Network.route to
      { settingsViewModel, navController, homeViewModel ->
        NetworkScreen(navController, settingsViewModel)
      },
    SettingRoutes.Notifications.route to
      { settingsViewModel, navController, homeViewModel ->
        NotificationsScreen(navController, settingsViewModel)
      },
    SettingRoutes.Proxy.route to
      { settingsViewModel, navController, homeViewModel ->
        ProxyScreen(navController, settingsViewModel)
      },
    SettingRoutes.Dns.route to
      { settingsViewModel, navController, homeViewModel ->
        DnsScreen(navController, settingsViewModel)
      },
    SettingRoutes.CustomBlocklist.route to
      { settingsViewModel, navController, homeViewModel ->
        CustomBlocklistManagementScreen(navController, settingsViewModel)
      },
    SettingRoutes.DomainManagement.route to
      { settingsViewModel, navController, homeViewModel ->
        DomainManagementScreen(navController, settingsViewModel)
      },
    SettingRoutes.Privacy.route to
      { settingsViewModel, navController, homeViewModel ->
        PrivacyScreen(navController, settingsViewModel)
      },
    SettingRoutes.About.route to
      { settingsViewModel, navController, homeViewModel ->
        AboutScreen(navController, settingsViewModel)
      },
  )
