...
fun DnsScreen(
  ...
  LaunchedEffect(
    ...
    settings.settings.value.autoUpdateEnabled,
  ) {
  ...
  fun updateSpecificList(
    targetList: String,
    onComplete: ((Boolean) -> Unit)? = null,
  ) {
    val inputData = Data.Builder().putStringArray("target_lists", arrayOf(targetList)).build()

    val workRequest =
      OneTimeWorkRequestBuilder<RuleDatabaseUpdateWorker>().setInputData(inputData).build()
  ...
  fun updateList(
    ...
    if (!useRootMode || canUpdateHosts || !enabled) {
      ...
      if (enabled) {
        val ruleName =
          when {
            lists.any { it in AppConstants.DnsBlockLists.MALWARE_PROTECTION } -> {
              "Malware Protection"
            }

            lists.any { it in AppConstants.DnsBlockLists.AD_PROTECTION } -> {
              "Ad Protection"
            }

            lists.any { it in AppConstants.DnsBlockLists.ADS_EXTREME } -> {
              "Ads Extreme"
            }

            lists.any { it in AppConstants.DnsBlockLists.PRIVACY_PROTECTION } -> {
              "Privacy Protection"
            }

            lists.any { it in AppConstants.DnsBlockLists.SOCIAL_PROTECTION } -> {
              "Social Media"
            }

            lists.any { it in AppConstants.DnsBlockLists.ADULT_PROTECTION } -> {
              "Adult Content"
            }

            lists.any { it in AppConstants.DnsBlockLists.GAMBLING_PROTECTION } -> {
              "Gambling"
            }
      ...
      CoroutineScope(Dispatchers.IO).launch {
        try {
          withContext(Dispatchers.Main) { isDomainUpdateInProgress = true }
          ...
          if (enabled) {
            ...
            withContext(Dispatchers.Main) { localSwitchStates[listKey] = false }
          }
          ...
          withContext(Dispatchers.Main) {
            if (enabled) {
              ...
              val inputData =
                Data.Builder().putStringArray("target_lists", lists.toTypedArray()).build()

              val workRequest =
                OneTimeWorkRequestBuilder<RuleDatabaseUpdateWorker>()
  ...
  SettingsScaffold(
    ...
    settingsContainer {
      SettingsBox(
        ...
        customAction = { onExit -> OnDNSClicked(settings, onExit) },
      )

      // Auto-update interval setting
      val autoUpdateIntervals =
        listOf(
            ...
            autoUpdateIntervals.forEach { (interval, label) ->
              item {
                SettingsBox(
                  ...
                  description =
                    stringResource(
                      R.string.dns_auto_update_description_template,
                      label.lowercase(),
                    ),
    ...
    settingsContainer {
      LaunchedEffect(doneNames.value) { CoroutineScope(Dispatchers.IO).launch { reloadDatabase() } }
      ...
      SettingsBox(
        ...
        actionType = SettingType.SWITCH,
        variable =
          localSwitchStates["MALWARE_PROTECTION"]
            ?: (
      ...
      SettingsBox(
        ...
        actionType = SettingType.SWITCH,
        variable =
          localSwitchStates["AD_PROTECTION"]
            ?: (
      ...
      SettingsBox(
        ...
        actionType = SettingType.SWITCH,
        variable =
          localSwitchStates["PRIVACY_PROTECTION"]
            ?: (
    ...
    settingsContainer {
      SettingsBox(
        ...
        actionType = SettingType.SWITCH,
        variable =
          localSwitchStates["SOCIAL_PROTECTION"]
            ?: (
      ...
      SettingsBox(
        ...
        actionType = SettingType.SWITCH,
        variable =
          localSwitchStates["ADULT_PROTECTION"]
            ?: (
      ...
      SettingsBox(
        ...
        actionType = SettingType.SWITCH,
        variable =
          localSwitchStates["GAMBLING_PROTECTION"]
            ?: (
    ...
    settingsContainer {
      ...
      SettingsBox(
        title =
          customBlocklistTitle + " " + stringResource(id = R.string.premium_feature_indicator),
        ...
        description =
          run {
            ...
            when {
              ...
              isDomainsLoading && !isDomainsInitialized -> {
                "Loading domains..."
              }
  ...
  if (showMagiskDialog) {
    MagiskSystemlessHostsDialog(onDismiss = { blockListViewModel.hideMagiskDialog() })
  }
  ...
  DownloadDialog(
    ...
    onRetry = {
      currentDownloadingRule?.let { ruleName ->
        val (listConstants, listKey) =
          when (ruleName) {
            "Malware Protection" -> {
              AppConstants.DnsBlockLists.MALWARE_PROTECTION to "MALWARE_PROTECTION"
            }

            "Ad Protection" -> {
              AppConstants.DnsBlockLists.AD_PROTECTION to "AD_PROTECTION"
            }

            "Ads Extreme" -> {
              AppConstants.DnsBlockLists.ADS_EXTREME to "ADS_EXTREME"
            }

            "Privacy Protection" -> {
              AppConstants.DnsBlockLists.PRIVACY_PROTECTION to "PRIVACY_PROTECTION"
            }

            "Social Media" -> {
              AppConstants.DnsBlockLists.SOCIAL_PROTECTION to "SOCIAL_PROTECTION"
            }

            "Adult Content" -> {
              AppConstants.DnsBlockLists.ADULT_PROTECTION to "ADULT_PROTECTION"
            }

            "Gambling" -> {
              AppConstants.DnsBlockLists.GAMBLING_PROTECTION to "GAMBLING_PROTECTION"
            }
