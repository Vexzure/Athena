...
fun defaultScreenEnterAnimation(): EnterTransition =
  fadeIn(animationSpec = tween(AppConstants.AnimationConstants.FADE_DURATION)) +
    scaleIn(
...
fun defaultScreenExitAnimation(): ExitTransition =
  fadeOut(animationSpec = tween(AppConstants.AnimationConstants.FADE_DURATION)) +
    scaleOut(
...
fun fastScreenExitAnimation(): ExitTransition =
  fadeOut(animationSpec = tween(120)) +
    scaleOut(targetScale = 0.98f, animationSpec = tween(150))
